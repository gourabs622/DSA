...
inline void create(struct Queue *q)
{
...
inline void display(struct Queue q)
{
...
inline void enqueue(struct Queue *q, int val)
{
    if (q->rare == q->size - 1)
    {
...
inline int dequeue(struct Queue *q)
{
    int x = -1;
    if (q->rare == q->front)
    {
...
inline void isEmpty(struct Queue q)
{
    if (q.front == q.rare)
    {
...
inline void isFull(struct Queue q)
{
    if (q.rare == q.size - 1)
    {
...
inline void front(struct Queue q)
{
    if (q.front == q.rare)
    {
        printf("Queue is Empty\n");
...
inline void back(struct Queue q)
{
    if (q.front == q.rare)
    {
        printf("Queue is Empty\n");
