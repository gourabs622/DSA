...
// Problem Link --> https://www.geeksforgeeks.org/number-subsequences-ab-string-repeated-k-times/
...
inline void solve()
{
    ...
    /* using two pointer and indexing --> O(n) and O(n) space */
