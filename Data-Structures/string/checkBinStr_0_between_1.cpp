...
// Problem Link --> https://www.geeksforgeeks.org/check-binary-string-0-1s-not-set-2-regular-expression-approach/
// Algo Concept --> https://www.geeksforgeeks.org/write-regular-expressions/
...
inline void solve()
{
    ...
    /* using indexing concept --> O(n) and O(n) space */
    vector<int> v;
    fi(i, 0, s.length())
    {
        if (s[i] == '1')
